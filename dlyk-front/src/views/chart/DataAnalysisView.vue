          ...
          <el-row :gutter="12">
            ...
            <el-col :span="12" class="filter-col">
              ...
              <el-radio-group v-model="customerDimension" class="dim-radio">
                <el-radio v-for="dim in customerOptions.dimensions" :key="'cd-' + dim" :value="dim"
          ...
          <el-row :gutter="12">
            ...
            <el-col :span="12" class="filter-col">
              ...
              <el-radio-group v-model="clueDimension" class="dim-radio">
                <el-radio v-for="dim in clueOptions.dimensions" :key="'ld-' + dim" :value="dim"
...
const dimLabelMap = {
  createBy: '创建人', source: '来源', age: '年龄', courseType: '课程类型', studying: '是否正在学习',
  intentionCourse: '意向课程', intentionStrength: '意向强度', clueStatus: '线索状态',
}
